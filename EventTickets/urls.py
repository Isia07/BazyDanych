...
from .objective_relational.views import (
    ...
    SeatTypeObjListCreateView, SeatTypeObjDetailView,
    EventListCreateView, EventDetailView,
    TicketListCreateView, TicketDetailView,
    OrderListCreateView, OrderDetailView,
    OrderTicketListCreateView, OrderTicketDetailView,
...
urlpatterns = [
    ...
    path('api/v1/obj-rel/order-tickets/', OrderTicketListCreateView.as_view(), name='obj_rel_order_tickets'),
    path('api/v1/obj-rel/order-tickets/<int:id>/', OrderTicketDetailView.as_view(), name='obj_rel_order_ticket_detail'),
