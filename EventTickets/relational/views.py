...
from .models import Discount, TicketType, Status, EventType, Message
from .serializers import DiscountSerializer, TicketTypeSerializer, StatusSerializer, EventTypeSerializer, MessageSerializer
